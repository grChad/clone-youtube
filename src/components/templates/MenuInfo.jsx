        ...
        <div className="boxSubs" onClick={functionSubs}>
          {subs ? 
            ...
            <button style={styleSpan}>
              SUSCRITO
              <svg onClick={callBell} aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox={cambiarCampana.medida}><path fill="currentColor" d={cambiarCampana.pathD} /></svg>
            </button>}
